...
We consider the development of this simple shell model code an absolutely useful tool to practise with the Configuration Interaction method. Coding such routines from scratch has been an higly formative experience:
\begin{itemize} 
\item translating the theoretical notions in a code language was a good way to understand better the formalism 
\item working on our own code provided us with the real picture of the technical difficulties to face in order to produce physically interesting results
