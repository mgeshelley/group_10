...
\begin{itemize}
\item degeneracy of our solution compared with the solutions at fixed $J$ in NushellX 
\item properties of the two-body matrix elements for exchanging of two-states
\end{itemize}
