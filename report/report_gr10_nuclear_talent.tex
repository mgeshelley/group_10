...
We extend our Python code in Sec.\ref{sec:ourcode}to describe, through full Configuration Interaction method, neutrons in the $sd$-model space with the goal to study a simple isotopic chain, $^{17}$O-$^{28}$O. During the development of our shell model code beyond the pairing model we compare our energy levels to calculations with NuShellX.
