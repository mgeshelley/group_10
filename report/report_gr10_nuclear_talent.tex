...
We have implemented an unit test that run the pairing model for the case we have tested numerically and if it is the same as the one we compute, the code continue to perform the asked calculation.
[Insert code here].
